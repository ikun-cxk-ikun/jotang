...
class Network(nn.Module):
    def __init__(self):
        ...
        # TODO:这里补全你的网络层
        self.conv1 = nn.Conv2d(3, 64, 3, 1)  # 卷积层1：输入通道3，输出通道32，卷积核大小3x3，步长1  
        self.conv2 = nn.Conv2d(64, 128, 3, 1) # 卷积层2：输入通道32，输出通道64，卷积核大小3x3，步长1  
        self.pool = nn.MaxPool2d(2, 2)  # 2x2池化窗口，步长为2  
        self.fc1 = nn.Linear(128*6*6, 1024)      # 全连接层1：输入特征数，输出特征数1024  
